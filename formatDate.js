...
function formatDate(date, mask, utc, gmt) {
  ...
  var flags = {
    d:    d,
    dd:   pad(d),
    ddd:  formatDate.i18n.dayNames[D],
    dddd: formatDate.i18n.dayNames[D + 7],
    m:    m + 1,
    mm:   pad(m + 1),
    mmm:  formatDate.i18n.monthNames[m],
    mmmm: formatDate.i18n.monthNames[m + 12],
    yy:   String(y).slice(2),
    yyyy: y,
    h:    H % 12 || 12,
    hh:   pad(H % 12 || 12),
